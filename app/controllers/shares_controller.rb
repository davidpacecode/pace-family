class SharesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @share.update(share_params)
        format.html { redirect_to @share, notice: "Share was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to shares_path, notice: "Share was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_share
      @share = Share.find(params.expect(:id))
    end
